...
Config ConfigLoader::Load(const std::string& file_path) {
    ...
    if(root["LidarOdometry"]){
        ...
        cfg.LidarOdometry_.voxel_resolution_x = getOrDefault(lidar_odometry, "voxel_resolution_x", cfg.LidarOdometry_.voxel_resolution_x);
        cfg.LidarOdometry_.voxel_resolution_y = getOrDefault(lidar_odometry, "voxel_resolution_y", cfg.LidarOdometry_.voxel_resolution_y);       
        cfg.LidarOdometry_.voxel_resolution_z = getOrDefault(lidar_odometry, "voxel_resolution_z", cfg.LidarOdometry_.voxel_resolution_z);
        cfg.LidarOdometry_.ndt_resolution = getOrDefault(lidar_odometry, "ndt_resolution", cfg.LidarOdometry_.ndt_resolution);
        cfg.LidarOdometry_.ndt_resolution_x = getOrDefault(lidar_odometry, "ndt_resolution_x", cfg.LidarOdometry_.ndt_resolution_x);
        cfg.LidarOdometry_.ndt_resolution_y = getOrDefault(lidar_odometry, "ndt_resolution_y", cfg.LidarOdometry_.ndt_resolution_y);
        cfg.LidarOdometry_.ndt_resolution_z = getOrDefault(lidar_odometry, "ndt_resolution_z", cfg.LidarOdometry_.ndt_resolution_z);
