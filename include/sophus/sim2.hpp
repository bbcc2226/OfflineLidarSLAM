...
public:
  ...
  SOPHUS_FUNC Sim2<NewScalarType> cast() const
  {
    return Sim2<NewScalarType>(
      rxso2().template cast<NewScalarType>(),
...
public:
  ...
  SOPHUS_FUNC Sim2(
    RxSO2Base<OtherDerived> const & rxso2,
  ...
  template<class D>
  SOPHUS_FUNC Sim2(
    Vector2<Scalar> const & complex_number,
    Eigen::MatrixBase<D> const & translation)
    ...
    const Tangent & a)
  {
    ...
    details::calcW_derivatives(
      theta, sigma, A, B, C, A_dsigma, B_dsigma,
